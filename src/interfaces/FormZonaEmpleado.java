...
public class FormZonaEmpleado extends JDialog {
	...
	public FormZonaEmpleado(Persistencia per, Zona zona) {
	...
	private void anniadir() throws Exception {
		if (table.getSelectedRow()>=0) {
			...
			this.zona.getEmpleados().add(e);
			per.guardarSinCommit(this.zona);
			per.refrescar(this.zona);
